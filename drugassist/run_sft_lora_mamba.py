...
def main():
    ...
    is_mamba = model_args.model_name_or_path.startswith("state-spaces/mamba-")
    ...
    if model_args.model_name_or_path:
        ...
        if is_mamba:
            ...
            model = MambaLMHeadModel.from_pretrained(model_args.model_name_or_path, device=device, dtype=dtype)
        else:

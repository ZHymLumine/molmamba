...
from caduceus.modeling_rcps import RCPSAddNormWrapper, RCPSEmbedding, RCPSLMHead, RCPSMambaBlock
...
class CaduceusHeadModel(nn.Module, GenerationMixin):
    ...
    def from_pretrained(cls, pretrained_model_name, device=None, dtype=None, **kwargs):
        ...
        config = CaduceusConfig(**config_data)
